...
output = device.send_command_timing('ping', strip_prompt=False, strip_command=False)
output += device.send_command_timing('\n', strip_prompt=False, strip_command=False)
output += device.send_command_timing('8.8.8.8', strip_prompt=False, strip_command=False)
output += device.send_command_timing('\n', strip_prompt=False, strip_command=False)
output += device.send_command_timing('\n', strip_prompt=False, strip_command=False)
output += device.send_command_timing('\n', strip_prompt=False, strip_command=False)
output += device.send_command_timing('\n', strip_prompt=False, strip_command=False)
